...
average_loan_price = (total / length)
print ("The Loan Costs are :", loan_costs )
print (length , "Loans costs are present" )
print ("The Total amount of the loans are $:", total)
...
print ("The amount of months remaining is : " + str(remaining_months))
...
print ("The Fair Value of the loan would be : ", fair_value)
...
if fair_value >= loan_price:
    print ("The Loan is worth at least the cost to buy it! Buy that thing boi")
else:
    print ("The Loan is too expensive and not worth the price! Bro Don't waste ur money")
